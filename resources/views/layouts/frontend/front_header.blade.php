					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 07922548454</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i>info@EX-plorer.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
								...
								<li class="dropdown"><a href="#">categories<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
									 @foreach($categories as $cat)
                                        <li><a href="{{url('categories',$cat->id)}}">{{$cat->categoryname}}</a></li>
									 @endforeach	
                                    </ul>
                                </li> 
